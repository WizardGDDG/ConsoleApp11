    ...
    static void Main()
    {
        ...
        for (double a = 0; a <= 6; a += 0.1)
        {
            for (double b = 0; b <= 6; b += 0.1)
            {
                ...
                {
                    Marker tochka = grafik1.Add.Marker(a, b);
        ...
        Scatter liniya1 = grafik1.Add.Scatter(x, x.Select(z => (3 - z) / 3).ToArray());
        liniya1.Color = Colors.Red;
        Scatter liniya2 = grafik1.Add.Scatter(x, x.Select(z => 2 - 2 * z).ToArray());
        liniya2.Color = Colors.Blue;
        Scatter liniya3 = grafik1.Add.Scatter(x, x.Select(z => 5 - z).ToArray());
        ...
        grafik1.SavePng(System.IO.Path.Combine(papka, "zadanie_a.png"), 600, 600);

        Plot grafik2 = new Plot();
        for (double q = 0; q <= 10; q += 0.1)
        {
            for (double w = 0; w <= 8; w += 0.1)
            {
                ...
                {
                    Marker tochka2 = grafik2.Add.Marker(q, w);
        ...
        Scatter lin1 = grafik2.Add.Scatter(xx, xx.Select(v => (9 + v) / 3).ToArray());
        lin1.Color = Colors.Red;
        Scatter lin2 = grafik2.Add.Scatter(xx, xx.Select(v => (18 - 2 * v) / 3).ToArray());
        lin2.Color = Colors.Blue;
        Scatter lin3 = grafik2.Add.Scatter(xx, xx.Select(v => 2 * v - 10).ToArray());
        ...
        grafik2.SavePng(System.IO.Path.Combine(papka, "zadanie_b.png"), 600, 600);
